...
class School(models.Model):
    ...
    # TODO: uncomment this when Mentors table get merged in
    # for now, just assume only one school per applicant,
    #     so we don't have to make a many to many field here
