...
const ApplicationForm = (props) => {
  ...
  // feedback
  const { feedbacks, handleFeedbackChange, checkValid } = useApplicationFormFeedback(undefined);
  ...
  const validations = {
    ...
    validateEmail: (fieldName, value) => {
      ...
      if(!re.test(value)) {
        handleFeedbackChange(fieldName, 'please enter email in format email@site.com');
        return false;
      } else {
        handleFeedbackChange(fieldName, '');
        return true;
    ...
    validatePhone: (fieldName, value) => {
      ...
      if (!re.test(value)) {
        handleFeedbackChange(fieldName, 'Please enter phone in format +999999999')
        return false;
      } else {
        handleFeedbackChange(fieldName, '');
        return true;
  ...
  const validateStep = (step) => {
    let fields = [];
    if(step === 1) {
      fields = ['first_name', 'last_name', 'preferred_name', 'gender', 'birth_date', 'country_of_origin', 'email', 'phone'];
    } else if(step === 2) {
      fields = ['grade_level', 'school_name', 'school_city', 'school_state', 'school_country', 'school_name', 'major']; 
    } else if(step === 3) {
    ...
    <div>
      <Section>
        ...
        <Form size="massive" onSubmit={handleSubmit}>
          {currentStep == 1 && (<div id="personalInfo">
          ...
          <br />
          {currentStep === 2 && (<div id="academicInfo">
          ...
          {currentStep === 3 && (<div id="mentorshipInterest">
