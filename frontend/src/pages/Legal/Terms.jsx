          ...
          <Grid.Row columns={1}>
            <Grid.Column>
              <StyledBodyText>
                ...
                <br />
                <StyledH2>AGREEMENT TO TERMS</StyledH2>
                <br />
                <br />
                ...
                <br />
                <br />
                <StyledH2>INTELLECTUAL PROPERTY RIGHTS</StyledH2>
                <br />
                <br />
                ...
                <br />
                <br />
                <StyledH2>USER REPRESENTATIONS</StyledH2>
                <br />
                <br />
                ...
                <br />
                <br />
                <StyledH2>USER REGISTRATION</StyledH2>
                <br />
                <br />
                ...
                <br />
                <br />
                <StyledH2>PROHIBITED ACTIVITIES</StyledH2>
                <br />
                <br />
                ...
                [other]
                <br />
                <StyledH2>USER GENERATED CONTRIBUTIONS</StyledH2>
                <br />
                <br />
                ...
                that violates, any provision of these Terms and Conditions, or
                ...
                <br />
                <br />
                <StyledH2>CONTRIBUTION LICENSE</StyledH2>
                <br />
                <br />
                ...
                <br />
                <br />
                <StyledH2>GUIDELINES FOR REVIEWS</StyledH2>
                <br />
                <br />
                ...
                <br />
                <br />
                <StyledH2>MOBILE APPLICATION LICENSE</StyledH2>
                <br />
                <br />
                Use License
                <br />
                ...
                <br />
                <br />
                <StyledH2>SOCIAL MEDIA</StyledH2>
                <br />
                <br />
                ...
                <br />
                <br />
                You hereby waive all moral rights to any such Submissions, and
                you hereby warrant that any such Submissions are original with
                ...
                <br />
                <br />
                <StyledH2>THIRD-PARTY WEBSITES AND CONTENT</StyledH2>
                <br />
                <br />
                ...
                you should be aware these Terms and Conditions no longer govern.
                <br />
                <br />
                ...
                harmless from any harm caused by your purchase of such products
                or services. Additionally, you shall hold us harmless from any
                ...
                subject to our Digital Millennium Copyright Act (“DMCA”) Notice
                and Policy provisions as described below, and you understand and
                ...
                <br />
                <br />
                <StyledH2>SITE MANAGEMENT</StyledH2>
                <br />
                <br />
                ...
                differ from applicable laws in the United States, then through
                ...
                <br />
                <br />
                <StyledH2>COPYRIGHT INFRINGEMENTS</StyledH2>
                <br />
                <br />
                We respect the intellectual property rights of others. If you
                believe that any material available on or through the Site
                ...
                <br />
                <br />
                <StyledH2>MODIFICATIONS AND INTERRUPTIONS</StyledH2>
                <br />
                <br />
                ...
                [name of state] applicable to agreements made and to be entirely
                performed within the State/Commonwealth of [name of state],
                without regard to its conflict of law principles.
                <br />
                <br />
                <StyledH2>DISPUTE RESOLUTION</StyledH2>
                <br />
                <br />
                Option 1: Any legal action of whatever nature brought by either
                you or us (collectively, the “Parties” and individually, a
                “Party”) shall be commenced or prosecuted in the state and
                federal courts located in [name of county] County, [name of
                state], and the Parties hereby consent to, and waive all
                ...
                Site be commenced more than ______ years after the cause of
                action arose.
                <br />
                <br />
                ...
                informally for at least ______ days before initiating
                ...
                state and federal courts located in [name of county] County,
                [name of state], and the Parties hereby consent to, and waive
                ...
                <br />
                Application of the United Nations Convention on Contracts for
                the International Sale of Goods and the the Uniform Computer
                Information Transaction Act (UCITA) are excluded from these
                Terms and Conditions.
                <br />
                <br />
                In no event shall any Dispute brought by either Party related in
                any way to the Site be commenced more than _____ years after the
                ...
                <br />
                To expedite resolution and control the cost of any dispute,
                controversy or claim related to these Terms and Conditions (each
                a “Dispute” and collectively, “Disputes”), any Dispute brought
                by either you or us (individually, a “Party” and collectively,
                the “Parties”) shall be finally and exclusively resolved by
                binding arbitration.
                <br />
                <br />
                YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE
                RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration
                shall be commenced and conducted under the Commercial
                ...
                shall be governed by the AAA Consumer Rules and, where
                appropriate, limited by the AAA Consumer Rules. [If such costs
                are determined to by the arbitrator to be excessive, we will pay
                all arbitration fees and expenses.]
                <br />
                <br />
                The arbitration may be conducted in person, through the
                ...
                either Party related in any way to the Site or Services be
                commenced more than ______ years after the cause of action
                arose.
                <br />
                <br />
                ...
                <br />
                <br />
                <StyledH2>LIMITATIONS OF LIABILITY</StyledH2>
                <br />
                <br />
                ...
                OF] [THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE
                [_________] MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING
                [OR] [$_________]. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS
                ...
                <br />
                <br />
                <StyledH2>CALIFORNIA USERS AND RESIDENTS</StyledH2>
                <br />
                <br />
                ...
                <br />
                <br />
                <StyledH2>MISCELLANEOUS</StyledH2>
                <br />
                <br />
